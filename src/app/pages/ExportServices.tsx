      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="mb-12">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold text-[#0b2d4d]">Export Services</h1>
          </div>
...
<div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Strategic Sourcing Across India</h2>
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Quality Control & Product Standardization</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Competitive & Sustainable Pricing</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Export Documentation & Regulatory Compliance</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">End-to-End Logistics & Shipment Handling</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Timely Execution & Delivery Commitment</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Market-Focused Export Approach</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
           ...
           <div className="bg-white border border-gray-200 rounded-xl p-5 md:p-8 shadow-sm hover:shadow-lg transition-all hover:-translate-y-1">
            ...
            <h2 className="text-xl md:text-2xl font-semibold text-[#0b2d4d] mb-4">Transparent Communication & Coordination</h2>
            <p className="text-sm md:text-[15px] text-gray-600 mb-6 leading-relaxed">
        ...
        {/* CTA Section */}
        <div className="mt-10 -mb-20 bg-gradient-to-r from-[#0b2d4d] to-[#1e293b] rounded-xl p-6 md:p-10 text-white text-center">
